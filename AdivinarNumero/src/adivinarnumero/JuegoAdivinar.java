 ...
 * @author ESFOT
 */
public class JuegoAdivinar extends javax.swing.JFrame {

    /**
     * Creates new form JuegoAdivinar
     */
    int contador = 0;
    Random numAleatorio = new Random(); // creamos una instancia de la clase
    int numAlet = numAleatorio.nextInt(1000);
    
    public JuegoAdivinar() {
        initComponents();
        System.out.println(numAlet); 
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Tengo un numero entre 1 y 100. Puede usted adivinarlo?");

        lblSubtitulo.setText("Ingrese un numero:");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(lblSubtitulo, javax.swing.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE))
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGap(45, 45, 45)
                                .addComponent(lblMensaje2, javax.swing.GroupLayout.DEFAULT_SIZE, 208, Short.MAX_VALUE)))))
                .addGap(21, 21, 21))
            .addGroup(layout.createSequentialGroup()
                .addGap(115, 115, 115)
                .addComponent(btnJugarNuevo, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(lblMensaje1, javax.swing.GroupLayout.PREFERRED_SIZE, 208, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(90, 90, 90))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(lblMensaje1, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void btnIntentarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIntentarActionPerformed
        ...
        int numIn = Integer.parseInt(txtNumero.getText());
        int numAl = numAlet;
        contador++;
        
        
        if (numIn == numAl ){
            lblMensaje1.setText("Adivinaste el numero");
            lblMensaje2.setText("");
            this.getContentPane().setBackground(Color.white);

        }else{
            if  (numIn> numAl){
                int rango = numIn - numAl;
                if (rango < 20){
                    this.getContentPane().setBackground(Color.red);
                    lblMensaje2.setText("");
                }else{
                    this.getContentPane().setBackground(Color.blue);
                    lblMensaje2.setText("Demasiado Alto");
                }
            }else if (numIn < numAl){
                int rango1 = numAl - numIn;
                if (rango1 < 20){
                    this.getContentPane().setBackground(Color.red);
                    lblMensaje2.setText("");
                }else{
                    this.getContentPane().setBackground(Color.blue);
                    lblMensaje2.setText("Demasiado Bajo");
                }  
            }
            
            txtNumero.setText("");
            lblMensaje1.setText("Intento "+contador);
    ...
    private void btnJugarNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnJugarNuevoActionPerformed
        // TODO add your handling code here:
        numAlet = numAleatorio.nextInt(1000);
        System.out.println(numAlet); 
        txtNumero.setText("");
        lblMensaje1.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JuegoAdivinar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JuegoAdivinar().setVisible(true);
            }
        });
    }
